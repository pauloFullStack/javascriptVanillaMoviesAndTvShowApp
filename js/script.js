  ...
  results.forEach((movie) => {
    ...
    div.innerHTML = `
       ...
       />`
        ...
        <p class="card-text">
            <small class="text-muted">Disponível: ${formatDate(
              movie.release_date
            )}</small>
        </p>
        </div>
  ...
  results.forEach((show) => {
    ...
    div.innerHTML = `
       ...
       />`
        ...
        <p class="card-text">
            <small class="text-muted">Data de exibição: ${datePtBr}</small>
        </p>
        </div>
    `;
...
const displayMovieDetails = async () => {
  ...
  <div>
    ...
    <p class="text-muted">Disponível: ${formatDate(movie.release_date)}</p>
    <p>
      ${movie.overview}
    </p>
    <h5>Gêneros</h5>
    ...
    <a href="${
      movie.homepage
    }" target="_blank" class="btn">Página inicial do filme</a>
  </div>
</div>
<div class="details-bottom">
  ...
  <ul>
    ...
    <li><span class="text-secondary">Tempo de execução:</span> ${
      movie.runtime
    } minutos</li>
...
const displayShowDetails = async () => {
  ...
  <div>
    ...
    <p class="text-muted">Última data de exibição: ${formatDate(
      show.last_air_date
    )}</p>
    <p>
      ${show.overview}
...
<div class="details-bottom">
  ...
  <ul>
    <li><span class="text-secondary">Episódios:</span> ${
      show.number_of_episodes
    }</li>
    <li><span class="text-secondary">Último episódio:</span> ${
...
const search = async () => {
  ...
  if (global.search.term !== "" && global.search.term !== null) {
    ...
    showAlert("Insira o termo de pesquisa");
  }
};
  ...
  results.forEach((result) => {
    ...
    div.innerHTML = `
       ...
       />`
        ...
        <p class="card-text">
            <small class="text-muted">Disponível: ${
...
const searchAPIData = async () => {
  ...
  const response = await fetch(
    `${API_URL}search/${global.search.type}?api_key=${API_KEY}&language=pt-BR&query=${global.search.term}&page=${global.search.page}`
  );
  const data = await response.json();
